            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div id="general" class="card-body">
                        ...
                        <!-- Visible Toolbar for Site Title -->
                        ...
                        <!-- Editable Site Title -->
                        <div contenteditable="true" class="card-text border p-2" id="site_title_rtf">
                            <strong>Example Site Title</strong>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="./inc/editGeneral.php" method="post">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="site_title" id="site_title_inp">
                                        ...
                                        <div contenteditable="true" class="form-control shadow-none border p-2" id="modal_site_title_rtf">
                                            <strong>Example Site Title</strong>
                                        </div>
                                    </div>
                                </div>
...
Customers must arrive 15 minutes before their scheduled appointment. Payment for services is required immediately after the session.
            ...
            <script>
                // Sync RTF content to the hidden input field before form submission
                document.querySelector('form').addEventListener('submit', function(e) {
                    const rtfContent = document.getElementById('modal_site_title_rtf').innerHTML;
                    document.getElementById('site_title_inp').value = rtfContent; // Save RTF content
                });

                // Sync changes between main page and modal
                document.getElementById('general-s').addEventListener('show.bs.modal', function() {
                    const mainRTF = document.getElementById('site_title_rtf').innerHTML;
                    document.getElementById('modal_site_title_rtf').innerHTML = mainRTF;
                });

                document.getElementById('general-s').addEventListener('hide.bs.modal', function() {
                    const modalRTF = document.getElementById('modal_site_title_rtf').innerHTML;
                    document.getElementById('site_title_rtf').innerHTML = modalRTF;
                });
